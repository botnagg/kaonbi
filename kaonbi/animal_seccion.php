			...
			<th>Tratamiento</th>
				...
				if($tratamiento) foreach ($tratamiento as $tratamientos):
					...
					<tr>
						...
						<td><a href="animal_edit.php?id=<?php echo $tratamientos['id']?>"><i class="glyphicon glyphicon-edit"></i></a></td>
						<td><a href="animal_delete.php?id=<?php echo $tratamientos['id']?>" onclick="return navConfirm(this.href);"><i class="glyphicon glyphicon-trash"></i></a></td>
					</tr>
					<?php endforeach; ?>
				</table>
